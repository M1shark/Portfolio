...
/* harmony import */ var _components_convas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/convas */ "./src/js/components/convas.js");
/* harmony import */ var _components_convas__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_convas__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _components_reviews__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/reviews */ "./src/js/components/reviews.js");
...
function accordion() {
  const content = document.querySelectorAll(".tabs__accordion-trigger");
  content.forEach(item => {
    item.addEventListener("click", e => {
      ...
      if (!item.classList.contains("content-active")) {
...
/***/ "./src/js/components/convas.js":
/*!*************************************!*\
  !*** ./src/js/components/convas.js ***!
  \*************************************/
/***/ (() => {

window.addEventListener("load", windowLoadHandler, false); //for debug messages
...
const tabNav = document.querySelectorAll(".tabs__nav-item");
...
function showTab() {
  ...
  tabNav[i].classList.add("tabs__nav-active");
}
